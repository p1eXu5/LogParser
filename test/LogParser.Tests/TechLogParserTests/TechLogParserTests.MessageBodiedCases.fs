    ...
    static member MessageBodied : IEnumerable =
        seq {
            TestCaseData(
                ...
                """,
                TechJsonLogField.MessageBoddied ("Returning next host:", jsonLog { Field "rabbitmq_node" 5672 })
            ...
            TestCaseData(
                ...
                """,
                TechJsonLogField.MessageBoddied ("Returning next EndPoint=IPEndPoint", jsonLog { Field "rabbitmq_node" 5672 })
